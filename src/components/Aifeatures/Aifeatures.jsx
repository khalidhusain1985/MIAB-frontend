          ...
          <ul role="list" className="space-y-5 my-7">
            <li className="flex items-center">
              ...
              <span className="text-base font-normal leading-tight text-black ms-3">
                Chat Encryption decryption with AI
                <br/>
                (Your chat get encrypted and decrypted with AI)
              </span>
            </li>
            <li className="flex items-center">
              <svg
        ...
        <div className="w-full max-w-sm p-4 bg-white  border border-gray-200 rounded-lg shadow sm:p-8 ">
          ...
          <ul role="list" className="space-y-5 my-7">
            <li className="flex items-center">
              ...
              <span className="text-base font-normal leading-tight text-black ms-3">
                Include All Features of Standard plans with advance AI features with AI Encryption decryption 
